...
<title>Tema Online | community <?php echo strtolower($_REQUEST['com']); ?></title>
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="EditRegion1" -->
  ...
  <!-- InstanceEndEditable --><!-- item lists --><!-- InstanceBeginEditable name="EditRegion2" -->
	...
	<div id="compname"><h2>COMMUNITY <?php echo strtoupper($_REQUEST['com']); ?></h2></div>
...
?>
	    <table class="cats" width="880" border="0">
	      <tr>
	        <td width="220"><img src="images/link.gif" alt="4" /> <a href="communities.inst.list.php?id=<?php echo $id[$j - 4]; ?>&com=<?php echo $_REQUEST['com']; ?>&comid=<?php echo $_REQUEST['id']; ?>&cat=<?php echo $category[$j - 4]; ?>"><?php echo $category[$j - 4]; ?></a></td>
            
	        <td width="220"><img src="images/link.gif" alt="3" /> <a href="communities.inst.list.php?id=<?php echo $id[$j - 3]; ?>&com=<?php echo $_REQUEST['com']; ?>&comid=<?php echo $_REQUEST['id']; ?>&cat=<?php echo $category[$j - 3]; ?>"><?php echo $category[$j - 3]; ?></a></td>
            
	        <td width="220"><img src="images/link.gif" alt="2" /> <a href="communities.inst.list.php?id=<?php echo $id[$j - 2]; ?>&com=<?php echo $_REQUEST['com']; ?>&comid=<?php echo $_REQUEST['id']; ?>&cat=<?php echo $category[$j - 2]; ?>"><?php echo $category[$j - 2]; ?></a></td>
            
	        <td><img src="images/link.gif" alt="1" /> <a href="communities.inst.list.php?id=<?php echo $id[$j - 1]; ?>&com=<?php echo $_REQUEST['com']; ?>&comid=<?php echo $_REQUEST['id']; ?>&cat=<?php echo $category[$j - 1]; ?>"><?php echo $category[$j - 1]; ?></a></td>
          </tr>
        </table>
	    <?php
	}
