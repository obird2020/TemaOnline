...
<title>Tema Online | communities</title>
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="EditRegion1" -->
  ...
  <!-- InstanceEndEditable --><!-- item lists --><!-- InstanceBeginEditable name="EditRegion2" -->
    ...
    $sql = "SELECT * FROM communities ORDER BY id ASC"." LIMIT $offset, $rowsperpage";
...
?>
	    <table class="cats" width="880" border="0">
	      <tr>
	        <td width="220"><img src="images/link.gif" alt="4" /> <a href="communities.inst.php?id=<?php echo $id[$j - 4]; ?>&com=<?php echo $community[$j - 4]; ?>"><?php echo $community[$j - 4]; ?></a></td>
	        <td width="220"><img src="images/link.gif" alt="3" /> <a href="communities.inst.php?id=<?php echo $id[$j - 3]; ?>&com=<?php echo $community[$j - 3]; ?>"><?php echo $community[$j - 3]; ?></a></td>
	        <td width="220"><img src="images/link.gif" alt="2" /> <a href="communities.inst.php?id=<?php echo $id[$j - 2]; ?>&com=<?php echo $community[$j - 2]; ?>"><?php echo $community[$j - 2]; ?></a></td>
	        <td><img src="images/link.gif" alt="1" /> <a href="communities.inst.php?id=<?php echo $id[$j - 1]; ?>&com=<?php echo $community[$j - 1]; ?>"><?php echo $community[$j - 1]; ?></a></td>
          </tr>
        </table>
	    <?php
	}
